...
import { ArrowLeft, Shield, FileText, RefreshCw, Sun, Moon } from 'lucide-solid';
...
export default function LegalPage({ defaultTab = 'terms', onBack }: LegalPageProps) {
  const [activeTab, setActiveTab] = createSignal<'terms' | 'privacy' | 'refunds'>(defaultTab);
  ...
  return (
    <div class="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-200 selection:bg-blue-600/10">
      {/* HEADER */}
      <header class="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors h-20 shrink-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          <div class="flex items-center gap-4">
            <button
              onClick={onBack}
              class="p-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider"
            >
              <ArrowLeft class="w-4 h-4" />
              <span>Back</span>
            </button>
            <div class="h-6 w-px bg-slate-200 dark:bg-slate-800" />
            <img src={logo} alt="LorryGuru Logo" class="h-14 w-auto object-contain" />
          </div>

          <button
            onClick={() => setTheme(theme() === 'light' ? 'dark' : 'light')}
            class="p-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-all cursor-pointer"
            title="Toggle Theme"
          >
      ...
      {/* MAIN LAYOUT */}
      <div class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row gap-8 min-h-0">
        {/* SIDEBAR NAVIGATION */}
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                class={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left text-sm font-bold transition-all cursor-pointer ${
                  isActive
              ...
              >
                <Icon class={`w-4 h-4 ${isActive ? 'text-white' : 'text-slate-400 dark:text-slate-500'}`} />
                <span>{tab.label}</span>
              </button>
            );
          })}
        ...
        {/* CONTENT CONTAINER */}
        <main class="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-10 shadow-sm overflow-y-auto max-h-[calc(100vh-12rem)] modern-scrollbar">
          {activeTab() === 'terms' && (
            <article class="prose dark:prose-invert max-w-none text-left space-y-6">
              <div>
                <h1 class="text-3xl font-black text-slate-900 dark:text-white leading-tight">Terms & Conditions</h1>
                <p class="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Last Updated: June 8, 2026</p>
              </div>

              <div class="h-px bg-slate-100 dark:bg-slate-800" />

              <p class="text-sm leading-relaxed text-slate-600 dark:text-slate-350">
                Welcome to LorryGuru. These Terms and Conditions (&quot;Terms&quot;) govern your use of the website located at{' '}
                <a href="https://lorryguru.in" class="text-blue-600 dark:text-blue-400 hover:underline">lorryguru.in</a>{' '}
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">1. Acceptance of Terms</h2>
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">2. Account Registration and Security</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">3. Usage Permissions and Access Controls</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">4. Acceptable Use Policy</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">5. Service Fees and Payments</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">6. Limitation of Liability</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">7. Governing Law and Jurisdiction</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">8. Contact Information</h2>
                <div class="p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 space-y-1">
                  <p class="font-bold text-slate-900 dark:text-white">Lorry Guru Technologies</p>
          ...
          {activeTab() === 'privacy' && (
            <article class="prose dark:prose-invert max-w-none text-left space-y-6">
              <div>
                <h1 class="text-3xl font-black text-slate-900 dark:text-white leading-tight">Privacy Policy</h1>
                <p class="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Last Updated: June 8, 2026</p>
              </div>
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">1. Information We Collect</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
                  We collect information necessary to deliver and manage your logistics portals:
                </p>
                <ul class="list-disc pl-5 text-xs space-y-2 text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">2. How We Use Your Information</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">3. Data Sharing and Third Parties</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">4. Data Protection and Encryption</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">5. Cookies and Local Storage</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">6. Contact Information</h2>
                <div class="p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 space-y-1">
                  <p class="font-bold text-slate-900 dark:text-white">Lorry Guru Technologies</p>
                  <p>Address: 5/6 Kodakarankady, Avarangampalayam, Sankari, Salem - 637301, Tamil Nadu, India.</p>
                  <p>Email: support@lorryguru.in</p>
          ...
          {activeTab() === 'refunds' && (
            <article class="prose dark:prose-invert max-w-none text-left space-y-6">
              <div>
                <h1 class="text-3xl font-black text-slate-900 dark:text-white leading-tight">Refund &amp; Cancellation Policy</h1>
                <p class="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Last Updated: June 8, 2026</p>
              </div>
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">1. Subscription Cancellation</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">2. Refund Eligibility</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">3. Exceptional Refund Cases</h2>
                <p class="text-xs leading-relaxed text-slate-600 dark:text-slate-400">
              ...
              <section class="space-y-3">
                <h2 class="text-lg font-bold text-slate-950 dark:text-white">4. Contact Information</h2>
                <div class="p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 space-y-1">
                  <p class="font-bold text-slate-900 dark:text-white">Lorry Guru Technologies</p>
                  <p>Address: 5/6 Kodakarankady, Avarangampalayam, Sankari, Salem - 637301, Tamil Nadu, India.</p>
                  <p>Email: support@lorryguru.in</p>
